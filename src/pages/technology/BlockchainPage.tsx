...
import { Link2, Shield, FileText, Lock, ArrowRight, CheckCircle2, Database, Network } from 'lucide-react';
...
const BlockchainPage: React.FC = () => {
  ...
  const applications = [
    {
      icon: Shield,
      title: "Secure Patient Data Sharing",
      description: "Blockchain-enabled secure sharing of patient data across healthcare providers while maintaining privacy and ensuring data integrity.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      icon: FileText,
      title: "Medical Records Integrity",
      description: "Immutable medical records that cannot be altered, ensuring the authenticity and completeness of patient health information.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      icon: Lock,
      title: "Data Security",
      description: "Enhanced security through decentralized architecture, reducing the risk of data breaches and unauthorized access.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: Network,
      title: "Interoperability",
      description: "Seamless data exchange between different healthcare systems and providers through blockchain-based networks.",
  ...
  const benefits = [
    ...
    "Transparent audit trails for all data transactions",
    "Patient-controlled access to their health data"
  ];
      ...
      <main className="flex-grow">
        ...
        >
          <div className="absolute inset-0">
            <video 
              src="https://dm0qx8t0i9gc9.cloudfront.net/watermarks/video/SNc_bPaMeiw63zp8r/videoblocks-plexus-of-the-points-of-the-heart_blxvlf-7x__1081e4b4ab6220fc2b28d48af8291733__P360.mp4"
              autoPlay
              loop
              muted
              playsInline
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className={`transition-all duration-1000 relative z-20 ${isVisible['hero'] ? 'opacity-100 translate-y-10' : 'opacity-0 translate-y-10'}`}>
                ...
                <p className="text-base sm:text-lg md:text-[21px] mb-6 md:mb-8 text-blue-100 leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)] md:drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                  Secure patient data sharing and medical records integrity through decentralized blockchain technology. A growing field transforming healthcare data management.
                </p>
                <Link
                  to="#applications"
                  onClick={(e) => {
              ...
              <div className={`transition-all duration-1000 delay-200 mt-8 lg:mt-0 ${isVisible['hero'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="relative rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 h-[300px] sm:h-[350px] md:h-[400px] lg:h-full lg:min-h-[400px] flex items-center justify-center">
                  <img
                    src="https://media.istockphoto.com/id/2217919487/photo/digital-healthcare-blockchain-network.webp?a=1&b=1&s=612x612&w=0&k=20&c=NF1fYxylm3M7bIPlKjecJgskgTykkJGiRNNgY3XHanw="
          ...
          <div className="container relative z-10">
            <div className="text-center mb-16">
              ...
              <p className={`text-lg md:text-xl text-slate-600 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['applications'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                How blockchain is securing healthcare data and records
              </p>
            </div>
          ...
          <div className="container relative z-10">
            <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible['cta'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6">
                Ready to Secure Healthcare Data with Blockchain?
              </h2>
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                Discover how blockchain technology can enhance data security, integrity, and interoperability in healthcare.
              </p>
