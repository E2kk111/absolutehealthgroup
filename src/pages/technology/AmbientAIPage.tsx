...
import { Mic, FileText, Clock, Heart, ArrowRight, CheckCircle2, Zap, Users } from 'lucide-react';
import { Card, CardContent } from '../../components/ui/card';
import { scrollToTop } from '../../utils/smoothScroll';

const AmbientAIPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: "Automatically captures and transcribes doctor-patient conversations in real-time without interrupting the clinical flow.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      icon: FileText,
      title: "Auto-Generated Notes",
      description: "Intelligently structures clinical notes, summaries, and documentation from natural conversation.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      icon: Clock,
      title: "Time Savings",
      description: "Reduces documentation time by up to 70%, allowing clinicians to focus on patient care.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: Heart,
      title: "Burnout Prevention",
      description: "Eliminates after-hours documentation burden, significantly reducing clinician burnout and improving work-life balance.",
  ...
  const benefits = [
    ...
    "Eliminates after-hours charting",
    "Enhances patient-clinician interaction",
    "Reduces administrative burden",
    "Improves clinician satisfaction and retention"
  ];
      ...
      <main className="flex-grow">
        ...
        >
          <div className="absolute inset-0">
            <video 
              src="https://dm0qx8t0i9gc9.cloudfront.net/watermarks/video/B4biS88geemab807y7/videoblocks-c16_rcelqd18lg__c4b6deb3c8561f34d4683c6e6ec0f0a9__P360.mp4"
              autoPlay
              loop
              muted
              playsInline
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className={`transition-all duration-1000 relative z-20 ${isVisible['hero'] ? 'opacity-100 translate-y-10' : 'opacity-0 translate-y-10'}`}>
                ...
                <p className="text-base sm:text-lg md:text-[21px] mb-6 md:mb-8 text-blue-100 leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)] md:drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                  Automatically listens to doctor-patient conversations and writes clinical notes, providing huge help against clinician burnout.
                </p>
                <Link
                  to="#features"
                  onClick={(e) => {
              ...
              <div className={`transition-all duration-1000 delay-200 mt-8 lg:mt-0 ${isVisible['hero'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="relative rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 h-[300px] sm:h-[350px] md:h-[400px] lg:h-full lg:min-h-[400px] flex items-center justify-center">
                  <img
                    src="https://media.istockphoto.com/id/2207754450/photo/ai-chatbot-assisting-doctor-health-care-and-medical-support-artificial-intelligence-in.webp?a=1&b=1&s=612x612&w=0&k=20&c=4mS5QJZXfAr8xMa1NoFGqy-kGdYYCmyn7pqdDoEK4Bs="
                    alt="Ambient AI"
          ...
          <div className="container relative z-10">
            <div className="text-center mb-16">
              ...
              <p className={`text-lg md:text-xl text-slate-600 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['features'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                How ambient AI transforms clinical documentation
              </p>
            </div>
          ...
          <div className="container relative z-10">
            <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible['cta'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6">
                Reduce Documentation Burden Today
              </h2>
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                See how ambient AI can transform your clinical workflow and reduce burnout.
              </p>
