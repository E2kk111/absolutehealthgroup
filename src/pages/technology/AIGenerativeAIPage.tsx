...
import { Brain, Sparkles, FileText, Stethoscope, Pill, MessageSquare, ArrowRight, CheckCircle2, Zap, Activity } from 'lucide-react';
import { Card, CardContent } from '../../components/ui/card';
import { scrollToTop } from '../../utils/smoothScroll';

const AIGenerativeAIPage: React.FC = () => {
  ...
  const applications = [
    {
      icon: Stethoscope,
      title: "Diagnostics",
      description: "AI-powered diagnostic tools that analyze medical images, lab results, and patient data to assist clinicians in accurate diagnosis.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      icon: Activity,
      title: "Radiology",
      description: "Advanced image analysis for radiology, detecting anomalies in X-rays, MRIs, CT scans with high precision and speed.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      icon: FileText,
      title: "Clinical Documentation",
      description: "Ambient listening technology that automatically generates clinical notes from doctor-patient conversations.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: Pill,
      title: "Drug Discovery",
      description: "Accelerating pharmaceutical research through AI-driven molecular analysis and drug compound optimization.",
      gradient: "from-orange-500 to-red-500"
    },
    {
      icon: MessageSquare,
      title: "Chatbots & Virtual Assistants",
      description: "Intelligent virtual assistants that provide 24/7 patient support, answer questions, and guide care navigation.",
  ...
  const benefits = [
    ...
    "Reduced clinician burnout through automated documentation",
    "Faster drug discovery and development cycles",
    "24/7 patient support and engagement",
    "Enhanced clinical decision-making support",
    "Cost reduction through workflow optimization"
  ];
      ...
      <main className="flex-grow">
        ...
        >
          <div className="absolute inset-0">
            <video 
              src="https://dm0qx8t0i9gc9.cloudfront.net/watermarks/video/H2qwMhbkqkzg2flz4/videoblocks-63f164d6c507744835eefb20_r2mhjywao__7418c529e44fc05f45df2b2d1fd3fe5d__P360.mp4"
              autoPlay
              loop
              muted
              playsInline
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className={`transition-all duration-1000 relative z-20 ${isVisible['hero'] ? 'opacity-100 translate-y-10' : 'opacity-0 translate-y-10'}`}>
                ...
                <p className="text-base sm:text-lg md:text-[21px] mb-6 md:mb-8 text-blue-100 leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)] md:drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                  Transforming healthcare through intelligent diagnostics, radiology, clinical documentation, drug discovery, and virtual assistants.
                </p>
                <Link
                  to="#applications"
                  onClick={(e) => {
              ...
              <div className={`transition-all duration-1000 delay-200 mt-8 lg:mt-0 ${isVisible['hero'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="relative rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 h-[300px] sm:h-[350px] md:h-[400px] lg:h-full lg:min-h-[400px] flex items-center justify-center">
                  <img
                    src="https://media.istockphoto.com/id/2190789793/photo/medicine-and-ai.webp?a=1&b=1&s=612x612&w=0&k=20&c=Y2rD0-XyPwMHp8F8rsiMMvN2QQcRNY7PkqiUagol8Pw="
                    alt="AI & Generative AI"
          ...
          <div className="container relative z-10">
            <div className="text-center mb-16">
              ...
              <p className={`text-lg md:text-xl text-slate-600 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['applications'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                How AI and Generative AI are revolutionizing healthcare delivery
              </p>
            </div>
          ...
          <div className="container relative z-10">
            <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible['cta'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                Discover how our AI-powered solutions can enhance your clinical workflows and improve patient outcomes.
              </p>
...
export default AIGenerativeAIPage;
