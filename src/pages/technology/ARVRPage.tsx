...
import { Eye, GraduationCap, Heart, Activity, ArrowRight, CheckCircle2, Sparkles, Scissors } from 'lucide-react';
  ...
  const applications = [
    {
      ...
      description: "Immersive 3D visualization of patient anatomy for precise surgical planning, reducing risks and improving outcomes through virtual rehearsal.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      icon: GraduationCap,
      title: "Medical Training",
      description: "Realistic virtual environments for medical education, allowing students and professionals to practice procedures safely without risk to patients.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      icon: Heart,
      title: "Pain Management",
      description: "VR-based distraction therapy and immersive experiences that help patients manage chronic pain and reduce reliance on medication.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: Activity,
      title: "Rehabilitation",
      description: "Interactive VR rehabilitation programs that make physical therapy engaging, track progress, and accelerate recovery through gamified exercises.",
      gradient: "from-orange-500 to-red-500"
    }
  ];

  const benefits = [
    "Enhanced surgical precision through 3D visualization",
    "Improved medical training outcomes with risk-free practice",
    "Reduced pain medication dependency through VR therapy",
    "Faster rehabilitation with engaging, interactive programs",
    "Better patient engagement and treatment adherence",
    "Cost-effective training and treatment solutions"
  ];
      ...
      <main className="flex-grow">
        ...
        >
          <div className="absolute inset-0">
            <video 
              src="https://dm0qx8t0i9gc9.cloudfront.net/watermarks/video/SZe0QQ5rcl2l9mvmt/videoblocks-doctors-use-vr-technology-holographic-screen-to-analyze-and-study-medical-d_bkppufg9h__a23a5785f0c3d22df1ac36d2dcaa0d0e__P360.mp4"
              autoPlay
              loop
              muted
              playsInline
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className={`transition-all duration-1000 relative z-20 ${isVisible['hero'] ? 'opacity-100 translate-y-10' : 'opacity-0 translate-y-10'}`}>
                ...
                <p className="text-base sm:text-lg md:text-[21px] mb-6 md:mb-8 text-blue-100 leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)] md:drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                  Transforming healthcare through immersive technologies for surgical planning, medical training, pain management, and rehabilitation.
                </p>
                <Link
                  to="#applications"
                  onClick={(e) => {
              ...
              <div className={`transition-all duration-1000 delay-200 mt-8 lg:mt-0 ${isVisible['hero'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="relative rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 h-[300px] sm:h-[350px] md:h-[400px] lg:h-full lg:min-h-[400px] flex items-center justify-center">
                  <img
                    src="https://media.istockphoto.com/id/1783632360/photo/doctor-virtual-reality-and-man-in-medicine-hologram-x-ray-scan-and-digital-transformation.webp?a=1&b=1&s=612x612&w=0&k=20&c=2Rz5ZrdXEvvKDv8Oe_boO9JCDp-Y56oVibG7TrW2AXM="
                    alt="AR/VR in Healthcare"
          ...
          <div className="container relative z-10">
            <div className="text-center mb-16">
              ...
              <p className={`text-lg md:text-xl text-slate-600 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['applications'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                How AR and VR are revolutionizing healthcare delivery
              </p>
            </div>
          ...
          <div className="container relative z-10">
            <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible['cta'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6">
                Ready to Transform Healthcare with AR/VR?
              </h2>
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                Discover how immersive technologies can enhance surgical planning, training, pain management, and rehabilitation.
              </p>
