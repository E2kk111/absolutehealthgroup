          ...
          <div className="container relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {services.map((service, index) => {
                ...
                const serviceImages = [
                  "https://media.istockpicture.com/id/2156781257/photo/hospital-integrated-advanced-technology-into-its-health-care-system-ensuring-medical-safety.webp?a=1&b=1&s=612x612&w=0&k=20&c=DDsc9N90RflslqBfY4HDBf4417irvQFf97ZXvS1MtUY=",
                  "https://media.istockpicture.com/id/1501183871/photo/doctors-registering-patients-at-the-hospital.webp?a=1&b=1&s=612x612&w=0&k=20&c=p_BnNwDwa9rcwE90AxDVbqx0CMkz3hN_DN31FzE-seM=",
