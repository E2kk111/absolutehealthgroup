...
import { Dna, Pill, Target, Activity, ArrowRight, CheckCircle2, Heart, Sparkles } from 'lucide-react';
import { Card, CardContent } from '../../components/ui/card';
import { scrollToTop } from '../../utils/smoothScroll';

const PrecisionMedicinePage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: "Comprehensive genetic analysis to identify individual risk factors, drug metabolism patterns, and treatment responses.",
      gradient: "from-blue-500 to-cyan-500"
    },
    {
      icon: Pill,
      title: "Tailored Treatments",
      description: "Personalized medication and therapy plans based on genetic profile, especially effective in oncology and rare diseases.",
      gradient: "from-purple-500 to-pink-500"
    },
    {
      icon: Target,
      title: "Oncology Focus",
      description: "Advanced precision medicine approaches for cancer treatment, including targeted therapies and immunotherapy selection.",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: Activity,
      title: "Predictive Analytics",
      description: "AI-driven analysis of genetic data to predict disease risk, treatment outcomes, and optimal intervention strategies.",
      gradient: "from-orange-500 to-red-500"
    }
  ];

  const benefits = [
    "Improved treatment efficacy through personalized approaches",
    "Reduced adverse drug reactions",
    "Better outcomes in oncology and rare diseases",
    "Optimized medication dosing based on genetics",
    "Early disease risk identification",
    "Cost-effective targeted therapies"
  ];
      ...
      <main className="flex-grow">
        ...
        >
          <div className="absolute inset-0">
            <video 
              src="https://dm0qx8t0i9gc9.cloudfront.net/watermarks/video/BgrICs-NZj4hksnn3/videoblocks-61d7fe0b2a335c6b5643ec92_rdqcormay__5f2b09aabd4687ab1cde6cfeee503e40__P360.mp4"
              autoPlay
              loop
              muted
              playsInline
          ...
          <div className="container relative z-10 py-8 md:py-12 px-4 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className={`transition-all duration-1000 relative z-20 ${isVisible['hero'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                ...
                <p className="text-base sm:text-lg md:text-[21px] mb-6 md:mb-8 text-blue-100 leading-relaxed drop-shadow-[0_2px_6px_rgba(0,0,0,0.8)] md:drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                  Genetic testing and tailored treatments, especially effective in oncology, delivering personalized care based on individual genetic profiles.
                </p>
                <Link
                  to="#features"
                  onClick={(e) => {
              ...
              <div className={`transition-all duration-1000 delay-200 mt-8 lg:mt-0 ${isVisible['hero'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <div className="relative rounded-xl md:rounded-2xl overflow-hidden bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-sm border border-white/10 h-[300px] sm:h-[350px] md:h-[400px] lg:h-full lg:min-h-[400px] flex items-center justify-center">
                  <img
                    src="https://media.istockphoto.com/id/1369150014/photo/artificial-intelligence-concept.webp?a=1&b=1&s=612x612&w=0&k=20&c=KqJZqJZqJZqJZqJZqJZqJZqJZqJZqJZqJZqJZqJZqJZq="
        ...
        >
          ...
          <div className="container relative z-10">
            <div className="text-center mb-16">
              <h2 className={`text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 mb-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 bg-clip-text text-transparent transition-all duration-1000 ${isVisible['features'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                Key Features
              </h2>
              <p className={`text-lg md:text-xl text-slate-600 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible['features'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {features.map((feature, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className={`group border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-white/90 backdrop-blur-xl hover:scale-105 hover:-translate-y-2 relative overflow-hidden ${isVisible['features'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                    style={{ transitionDelay: `${index * 100}ms` }}
                  >
                    <CardContent className="p-6 md:p-8">
                      <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-xl mb-4 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
          ...
          <div className="container relative z-10">
            <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible['cta'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6">
                Start Your Precision Medicine Journey
              </h2>
              <p className="text-xl md:text-2xl text-blue-100 mb-8 leading-relaxed">
                Discover how personalized medicine can improve treatment outcomes for your patients.
              </p>
...
export default PrecisionMedicinePage;
