...
const AIONStacksSection: React.FC = () => {
  const stacks = [
    {
      icon: Brain,
      title: "Intelligence",
      ...
      <div className="container relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 bg-clip-text text-transparent">
            AION Stacks Overview
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Three integrated platforms powering intelligent healthcare delivery
          </p>
        </div>
...
export default AIONStacksSection;
